...
class m160414_093837_addI18nTables extends Migration
{
    ...
    public function safeUp()
    {
        ...
        $tableSourceExist = $this->db->getTableSchema($sourceMessageTable, true);
        if (!$tableSourceExist)
        {
        ...
        $tableMessageExist = $this->db->getTableSchema($messageTable, true);
        if (!$tableMessageExist)
        {
        ...
        if (!$tableMessageExist && !$tableSourceExist)
        {
